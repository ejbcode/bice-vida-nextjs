...
const SelectingInsurance: React.FC<Props> = ({ insurances }) => {
  ...
  const optionSelected = insurances.filter((insurance) => insurance.id === option)
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p>En BiceVida pensamos en ti. Encuentra el seguro que mejor se adapte a tus necesidades </p>
